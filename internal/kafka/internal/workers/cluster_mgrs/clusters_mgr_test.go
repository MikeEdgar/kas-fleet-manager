	...
	observabilityConfig = &observatorium.ObservabilityConfiguration{
		...
		DataPlaneObservabilityConfig: observatorium.DataPlaneObservabilityConfig{
			...
			RemoteWriteConfiguration: observatorium.DataPlaneObservabilityRemoteWriteConfiguration{
				...
				Authentication: observatorium.DataPlaneObservabilityRemoteWriteAuthentication{
					OIDC: &observatorium.DataPlaneObservabilityRemoteWriteAuthTypeOIDC{
						Autogenerated: &observatorium.DataPlaneObservabilityOIDCAutogenerated{},
					},
				},
			},
...
func buildResourceSet(observabilityConfig observatorium.ObservabilityConfiguration, clusterConfig config.DataplaneClusterConfig, ingressDNS string, cluster *api.Cluster) (types.ResourceSet, error) {
	...
	if observabilityConfig.DataPlaneObservabilityConfig.HasStaticOIDCConfiguration() == false {
